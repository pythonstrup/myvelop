...
tags: ["AOP","Aspect","spel","Spring","분산 락","java"]
series: "동시성 제어"
---
...
![횡단 관심사에 대해 설명 이미지](../../../assets/blog/concurrency-control-aop/01.png)
...
![비즈니스 로직에서 횡단 관심사를 분리하지 않았을 때](../../../assets/blog/concurrency-control-aop/02.png)

이때 핵심 비즈니스 로직 곳곳에 흩어져 있는 횡단 관심사를 하나의 클래스에 모아서 처리할 수 있다.

Spring AOP에서 그 모듈을 Asepct라고 한다.

![Aspect 적용](../../../assets/blog/concurrency-control-aop/03.png)
...
![내부 메소드를 호출하면 프록시가 아닌 원본을 호출한다.](../../../assets/blog/concurrency-control-aop/04.png)
...
![클래스를 나눠 외부에서 호출해야 프록시가 정상적으로 동작한다.](../../../assets/blog/concurrency-control-aop/05.png)
