...
socialImage: "../../../assets/blog/external-api-virtual-threads/03.png"
...
![서버 사이드 이벤트 추적](../../../assets/blog/external-api-virtual-threads/01.png)
...
![플랫폼 스레드의 블로킹](../../../assets/blog/external-api-virtual-threads/02.png)
...
![가상스레드 풀 구성도](../../../assets/blog/external-api-virtual-threads/03.png)

요청을 처리하기 위해 스레드를 할당할 때, 가상 스레드는 Mount 과정을 통해 Carrier Thread와 연결된다.

![가상 스레드의 Mount](../../../assets/blog/external-api-virtual-threads/04.png)

이때 가상스레드가 I/O 작업을 만나면 Unmount를 통해 연결을 끊고, 다른 가상스레드가 Carrier Thread를 사용할 수 있는 상태로 만든다. 이게 가상 스레드가 Non-Blocking으로 동작하는 방식이다.

![가상 스레드의 Unmount](../../../assets/blog/external-api-virtual-threads/05.png)
...
![Connector/J 9.x의 가상 스레드 지원](../../../assets/blog/external-api-virtual-threads/06.png)
...
![데코레이터 세마포어를 활용한 데이터베이스 유량 제어](../../../assets/blog/external-api-virtual-threads/07.png)
