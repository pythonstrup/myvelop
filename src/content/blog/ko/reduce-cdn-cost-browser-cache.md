...
![한국과 미국 사이의 거리](../../../assets/blog/reduce-cdn-cost-browser-cache/01.png)
...
![CDN의 원리](../../../assets/blog/reduce-cdn-cost-browser-cache/02.png)
...
![NCloud Global Edge 요금 정보](../../../assets/blog/reduce-cdn-cost-browser-cache/03.png)
...
![응답 결과 캐싱](../../../assets/blog/reduce-cdn-cost-browser-cache/04.png)
...
![브라우저 캐시 유효 검증](../../../assets/blog/reduce-cdn-cost-browser-cache/05.png)

만약 캐시가 유효하다면 캐시 저장소에서 값을 반환하고 서버를 호출하지 않는다.

![캐시에서 조회](../../../assets/blog/reduce-cdn-cost-browser-cache/06.png)

#### 3\. 재차 요청: 캐시가 유효하지 않은 경우

만약 재차 요청을 했고 캐시를 검증했는데 시간이 초과하여 유효하지 않다면 어떻게 될까?

![캐시 유효성 검증 실패](../../../assets/blog/reduce-cdn-cost-browser-cache/07.png)

그 땐 다시 서버에 값을 다시 요청하고, 그 응답값을 다시 캐시에 저장한다.

![서버로 재요청 및 캐시 재저장](../../../assets/blog/reduce-cdn-cost-browser-cache/04.png)
...
![ncloud 캐시 상세 룰](../../../assets/blog/reduce-cdn-cost-browser-cache/08.png)

원하는 정적 리소스의 Directory, File Extension 등을 설정하고, 원본 Cache-Control 헤더 우선으로 설정해준다. 그리고 Advanced settings에서 브라우저 캐시를 허용해주자.

![ncloud 캐시 룰 설정](../../../assets/blog/reduce-cdn-cost-browser-cache/09.png)

이제 정적 리소스를 호출해보자. Cache-Control 헤더가 붙은 걸 확인할 수 있다.

![응답값에 Cache-Control 헤더 확인](../../../assets/blog/reduce-cdn-cost-browser-cache/10.png)

해당 정적 리소스를 다시 호출하면 해당 요청에 캐싱된 것을 확인할 수 있다.

![요청이 캐싱된 것을 확인](../../../assets/blog/reduce-cdn-cost-browser-cache/11.png)
...
![딸깍](../../../assets/blog/reduce-cdn-cost-browser-cache/12.webp)
