...
![How IRSA works — from the role ARN annotation on the ServiceAccount, through the Pod Identity Webhook and the projected token, to STS AssumeRoleWithWebIdentity issuing temporary credentials](../../../assets/blog/passwordless-db-access-least-privilege/irsa.svg)
