...
socialImage: "../../../assets/blog/bullmq-notification-part-5-queue-order/og.png"
---

import WaitingChildrenDemo from "@/materials/bullmq-notification-part-5-queue-order/WaitingChildrenDemo";
import PrematureSendDemo from "@/materials/bullmq-notification-part-5-queue-order/PrematureSendDemo";
import GroupFanInDiagram from "@/materials/bullmq-notification-part-5-queue-order/GroupFanInDiagram";
import FlowProducerMismatchDemo from "@/materials/bullmq-notification-part-5-queue-order/FlowProducerMismatchDemo";
import { CreateRaceDemo, HeartbeatWatchdogDemo, ReportOnceDemo, ResendGuardDemo, RestageDemo, RolloverRaceDemo, SendDedupeDemo } from "@/materials/bullmq-notification-part-5-queue-order/GroupRaceDemos";

## Introduction

[Part 2](/blog/bullmq-notification-part-2-rate-limit) tuned the rate limit, and [Part 3](/blog/bullmq-notification-part-3-delivery-history) and [Part 4](/blog/bullmq-notification-part-4-reading-history) covered delivery history. Through all of that, the send itself stayed simple. One chunk job sent its share right away, and that was it.
