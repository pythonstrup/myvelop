...
socialImage: "../../../assets/blog/pessimistic-lock-like-feature/01.png"
tags: ["java","redis","RedisLockRegistry","Spring","concurrency control","pessimistic locking","MySQL"]
...
The previous article, ["Solving a Concurrency Problem with a Single UPDATE"](/blog/concurrency-single-update/), covered concurrency control without an explicit read lock. In this case, however, <strong>we have to create data that does not yet exist</strong>, so we cannot use an exclusive lock or optimistic locking.
...
![Sample data for the (review_id) index](../../../assets/blog/pessimistic-lock-like-feature/04.png)

*Sample data for the (`review_id`) index*

MySQL places a next-key lock on the index range where `review_id=1`.

![Locking with the (review_id) index](../../../assets/blog/pessimistic-lock-like-feature/05.png)
...
![Sample data for the (member_id) index](../../../assets/blog/pessimistic-lock-like-feature/07.png)

*Sample data for the (`member_id`) index*

A bottleneck occurs when one member likes multiple reviews simultaneously.

![Locking with the (member_id) index](../../../assets/blog/pessimistic-lock-like-feature/08.png)
...
![Sample data for the (review_id, member_id) index](../../../assets/blog/pessimistic-lock-like-feature/10.png)
...
![Locking with the (review_id, member_id) index](../../../assets/blog/pessimistic-lock-like-feature/11.png)
...
If you want to learn more about Redis distributed locks, I recommend ["Myths and Facts About Lettuce Distributed Locks"](/blog/lettuce-distributed-lock-myths/).
