...
tags: ["mcp", "claude", "llm"]
socialImage: "../../../assets/blog/mcp-proxy-memory/mcp.png"
---
## Introduction
...
![Activity Monitor showing dozens of @modelcontextprotocol MCP server processes, each holding 50–90MB of memory](../../../assets/blog/mcp-proxy-memory/mcp.png)
...
![A process list where the same MCP servers appear dozens of times, differing only by PID](../../../assets/blog/mcp-proxy-memory/mcp-processes.png)
...
![A resource manager view where per-session RSS adds up to 10.57GB](../../../assets/blog/mcp-proxy-memory/resource-manager.png)
